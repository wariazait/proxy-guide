...
## Шаг 4. Подключение к VLESS или Hysteria2 через ссылку
...
В этот момент программа попросит перезапустить себя от имени администратора. Соглашаемся. После перезапуска снова активируем переключатель "Включить TUN".
...
В итоге настройки нижней панели будут выглядеть так:

![img.png](../assets/tun-mode.png)
...
![img.png](../assets/system-proxy.png)
...
Для выключения VPN полностью нужно выключить TUN-режим и/или очистить системный прокси. 

Вот такие настройки означают, что VPN выключен.

![img.png](../assets/vpn-disabled.png)

Об этом также будет говорить синий цвет иконки в трее.
